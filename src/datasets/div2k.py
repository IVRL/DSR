...
class Div2K(SRDataset):
    ...
    paths = {
        ...
        ('bicubic', 'train', Fraction(50, 9)): os.path.join('DIV2K_train_LR_bicubic', 'X50_9'),
        ...
        ('hr', 'valid', 1): os.path.join('DIV2K_valid_HR'),
        ('hr', 'valid', 2): os.path.join('DIV2K_valid_HR'),
        ('hr', 'valid', 3): os.path.join('DIV2K_valid_HR'),
        ('hr', 'valid', 4): os.path.join('DIV2K_valid_HR'),
        ('hr', 'valid', Fraction(50, 9)): os.path.join('DIV2K_valid_HR_X50_9'),
        ('bicubic', 'valid', 2): os.path.join('DIV2K_valid_LR_bicubic', 'X2'),
        ('bicubic', 'valid', 3): os.path.join('DIV2K_valid_LR_bicubic', 'X3'),
        ('bicubic', 'valid', 4): os.path.join('DIV2K_valid_LR_bicubic', 'X4'),
        ('bicubic', 'valid', Fraction(50, 9)): os.path.join('DIV2K_valid_LR_bicubic', 'X50_9'),
        # ('bicubic', 'valid', 8): os.path.join('DIV2K_valid_LR_x8'),
        # ('unknown', 'valid', 2): os.path.join('DIV2K_valid_LR_unknown', 'X2'),
        # ('unknown', 'valid', 3): os.path.join('DIV2K_valid_LR_unknown', 'X3'),
        # ('unknown', 'valid', 4): os.path.join('DIV2K_valid_LR_unknown', 'X4'),
        # ('real_mild', 'valid', 4): os.path.join('DIV2K_valid_LR_mild'),
        # ('real_difficult', 'valid', 4): os.path.join('DIV2K_valid_LR_difficult'),
        ...
        # ('real_wild', 'valid', 4): os.path.join('DIV2K_valid_LR_wild'),
        ('hr', 'test', 1): os.path.join('DIV2K_valid_HR'),
        ('hr', 'test', 2): os.path.join('DIV2K_valid_HR'),
        ('hr', 'test', 3): os.path.join('DIV2K_valid_HR'),
        ('hr', 'test', 4): os.path.join('DIV2K_valid_HR'),
        ('hr', 'test', Fraction(50, 9)): os.path.join('DIV2K_valid_HR_X50_9'),
        ('bicubic', 'test', 2): os.path.join('DIV2K_valid_LR_bicubic', 'X2'),
        ('bicubic', 'test', 3): os.path.join('DIV2K_valid_LR_bicubic', 'X3'),
        ('bicubic', 'test', 4): os.path.join('DIV2K_valid_LR_bicubic', 'X4'),
        ('bicubic', 'test', Fraction(50, 9)): os.path.join('DIV2K_valid_LR_bicubic', 'X50_9'),
    }
    ...
    def __init__(self,
        ...
        super(Div2K, self).__init__(root=os.path.join(root, 'Div2K'),
                                    scale=scale,
